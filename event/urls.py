...
urlpatterns = [
	...
	url(r'^ranking/binet/$',views.rankingbinets, name='ranking-binets'),
	url(r'^ranking/nageur/$',views.rankingnageurs, name='ranking-nageurs'),
	url(r'^ranking/binet/(?P<binet>\w+)$',views.rankingbinet, name='ranking-binet'),
